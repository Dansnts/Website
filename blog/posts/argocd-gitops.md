...
S'ils diffèrent, l'app est marquée `OutOfSync`. Selon la politique, ArgoCD synchronise automatiquement (ou attend une validation manuelle). Résultat, le cluster converge toujours vers Git.
